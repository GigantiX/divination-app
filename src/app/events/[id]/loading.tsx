        ...
        <div className="flex min-h-screen flex-col bg-background-secondary pb-20">
            ...
            <div className="sticky top-0 z-10 bg-card shadow-sm">
                <div className="flex items-center justify-between px-4 py-3">
                    ...
                    <div className="h-5 w-40 animate-pulse rounded-lg bg-muted-foreground/20" />
                    <div className="h-8 w-8 animate-pulse rounded-lg bg-muted-foreground/20" />
                </div>
            ...
            <div className="space-y-6 p-4">
                ...
                {/* Chart skeleton */}
                <div className="h-52 animate-pulse rounded-2xl bg-card shadow-sm" />
                ...
                <div className="space-y-3">
                    {[1, 2].map((i) => (
                        <div
                            key={i}
                            className="h-24 animate-pulse rounded-xl bg-card shadow-sm"
                        />
                    ))}
                </div>
            </div>
