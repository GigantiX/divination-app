        ...
        <div className="flex min-h-screen flex-col bg-background-secondary">
            ...
            <div className="sticky top-0 z-10 border-b bg-card px-6 py-4">
                <div className="flex items-center justify-between">
                    <div className="h-8 w-32 animate-pulse rounded-lg bg-muted-foreground/20" />
            ...
            <div className="flex-1 p-6">
                ...
                <div className="mb-8 space-y-2">
                    <div className="h-7 w-48 animate-pulse rounded-lg bg-muted-foreground/20" />
                    <div className="h-7 w-40 animate-pulse rounded-lg bg-muted-foreground/20" />
                    <div className="mt-2 h-6 w-20 animate-pulse rounded-full bg-muted-foreground/20" />
                </div>

                {/* Section header */}
                <div className="mb-4 flex items-center justify-between">
                    <div className="h-5 w-28 animate-pulse rounded-lg bg-muted-foreground/20" />
                    <div className="h-4 w-16 animate-pulse rounded-lg bg-muted-foreground/20" />
                </div>
                    ...
                    {[1, 2, 3].map((i) => (
                        <div key={i} className="rounded-xl bg-card p-4 shadow-sm">
                            <div className="flex items-center gap-4">
                                <div className="h-16 w-16 flex-shrink-0 animate-pulse rounded-lg bg-muted-foreground/20" />
